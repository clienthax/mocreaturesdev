...
public class ModSettings {
     ...
     * @param location The location that this context stores and loads data
     *        from.
     */
     ...
     * convenience boolean setting adder
     */
    public SettingBoolean addSetting(ModSettingScreen screen, String nicename, String backendname, boolean value, String truestring,
            String falsestring) {
        SettingBoolean s = new SettingBoolean(backendname, value);
     ...
     *
     * @param s setting to add - sets s.parent as well, don't add a setting to
     ...
     *
     * @param src The source context from which to copy.
     * @param dest The destination context to save to.
     */
    ...
    public void load(String context) {
        for (;;) {
            try {
                ...
                File path = ModSettings.getAppDir("/" + ModSettings.contextDatadirs.get(context) + "/" + this.backendname + "/");
                if (!path.exists()) {
                    break;
                }
